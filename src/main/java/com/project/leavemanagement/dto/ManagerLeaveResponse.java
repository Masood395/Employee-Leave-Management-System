...
public class ManagerLeaveResponse {
	...
	public ManagerLeaveResponse(int id, User userId, LocalDate start_date, LocalDate end_date, String reason,
			Status status, LocalDateTime appliedAt, LocalDateTime updatedAt) {
		super();
		this.id = id;
